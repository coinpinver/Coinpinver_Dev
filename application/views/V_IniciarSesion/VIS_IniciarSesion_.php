...
<section class="container d-flex align-items-center mb-lg-6 mb-sm-6 pt-lg-6 pt-sm-6 pb-md-4" style="flex: 1 0 auto;">
				...
				<div class="view show" id="signin-view">
					...
					<form id="iniciarSesion" name="iniciarSesion" method="POST">
						...
						<div class="d-flex justify-content-between align-items-center mb-3 pb-1">
							...
							<a class="nav-link-style fs-ms" href="<?=base_url("index.php/Recuperar-Contrasenia-Suscriptor")?>">¿Se te olvidó tu contraseña?</a>
						</div>
						...
						<p class="fs-sm pt-3 mb-0">¿No tienes una cuenta? <a href="<?=base_url("index.php/Suscripcion")?>" class="fw-medium" data-view="#signup-view">Suscríbete</a></p>
					</form>
				</div>
			</div>
		</div>
