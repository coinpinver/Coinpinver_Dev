...
<script src="<?=base_url("js/JS_IniciarSesion/JSIS_ConfirmarCuentaUsuario.js")?>?t=<?=time()?>"></script>
			...
			<div class="card card-horizontal">
				...
				<div class="card-body">
					<form id="confirmaCuentaSuscriptor" name="confirmaCuentaSuscriptor" method="POST">
						<input type="hidden" name="hashUsuario" id="hashUsuario" class="form-control form-control-sm oculto" value="<?=$informacion['hashUsuario']?>">
