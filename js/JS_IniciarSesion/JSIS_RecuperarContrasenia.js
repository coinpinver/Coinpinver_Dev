...
function setActionRecoveryAction(btn) {
	...
	if(banderaAction === 1) {
		Accion_JQueryRC("restaurarContraseniaSuscriptor", route, "result-recovery-password", tituloEspera, mensajeEspera, 1);
	}
}

function recargaDatosRC() {
...
function Accion_JQueryRC(formulario, controlador, elemento_respuesta, tituloEsperando, mensajeEsperando, banderaRecargaDatos) {
	if(tituloEsperando !== "") {
